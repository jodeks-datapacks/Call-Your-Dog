...
function callyourdog:check_dog_uuid_match_horn_uuid with storage callyourdog:root
...
execute if score &UUID_check check.callyourdog matches 0 run function callyourdog:get_latest_position with storage callyourdog:root
...
execute if score &UUID_check check.callyourdog matches 0 run function callyourdog:teleport_dog with storage callyourdog:root
